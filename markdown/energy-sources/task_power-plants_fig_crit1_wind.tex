...
%            },
           % sankey debug,
            ...
            \sankeyfork{p0}{3.3/p1,2.7/p2}

            \coordinate[right=1mm of p1.center] (p1 label);


            \sankeyadvance{p1}{120pt}
            ...
            \sankeyfork{p1}{2.31/p3,0.99/p4}


            \coordinate[right=1mm of p3.center] (p3 label);

            \sankeyadvance{p3}{120pt}


            \sankeynodeend{2.31}{0}{p3}{p3}
           ...
           \coordinate[below=1mm of p4.center] (p4 label);
            ...
            \node[label,right=1mm of p0 label] {Bewegungsenergie\\des Winds};
           % \node[label,right=1mm of p1 label] {Elektrische\\ Energie (53\,\%)};
            \node[label,right=1mm of p3 label] {Ins Netz eingespeiste\\elektrische Energie (45\,\%)};

            \node[label,below=3mm of p2 label,align=center] {Energieentwertung\\Rotor (47\,\%)};
            \node[label,below=3mm of p4 label,align=center] {Energieentwertung\\bspw. Transformator (8\,\%)};
