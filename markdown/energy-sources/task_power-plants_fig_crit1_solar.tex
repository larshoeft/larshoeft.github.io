    ...
    sankey fill/.append style={
        ...
        gray!46,
           ...
           \coordinate[below=1mm of p5.center] (p5 label);
            ...
            \node[label,right=1mm of p0 label] {Strahlungsenergie};
           % \node[label,right=1mm of p1 label] {Elektrische\\ Energie (53\,\%)};
            \node[label,right=1mm of p3 label] {Ins Netz eingespeiste\\elektrische Energie (21\,\%)};

            \node[label,below=3mm of p2 label,align=center] {Energieentwertung\\Photonen (46\,\%)};
            \node[label,below=3mm of p4 label,align=center] {Energieentwertung\\Diffusion (17\,\%)};
            \node[label,below=3mm of p5 label,align=center] {Energieentwertung\\Sonstiges (16\,\%)};
        \end{sankeydiagram}
    \end{tikzpicture}
\end{document}