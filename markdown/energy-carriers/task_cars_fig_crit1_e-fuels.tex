...
\begin{document}
 ...
 \begin{sankeydiagram}[
    ...
    \sankeynodestart{6}{0}{e0}{0,-400};

    \coordinate[below=1mm of e0.center] (e0 label);

    \sankeyadvance{e0}{80pt}

    \tikzset{sankey fill/.append style={line width=0pt,gray!67}}

    \sankeyfork{e0}{4.02/e1,1.98/e2}

    \coordinate[below=0mm of e1.center] (e1 label);

    \sankeyadvance{e1}{75pt}

    \tikzset{sankey fill/.append style={line width=0pt,gray!44}}

    \sankeyfork{e1}{1.92/e3,2.1/e4}

    \sankeyadvance{e3}{75pt}

    \coordinate[above=0mm of e3.center] (e3 label);

    \sankeyfork{e3}{1.56/e3,0.36/e5}

    \tikzset{sankey fill/.append style={line width=0pt,gray!17}}

    \sankeyadvance{e3}{75pt}

    \coordinate[above=0mm of e3.center] (e6 label);

    \sankeynodeend{1.56}{0}{e3}{e3}

    \tikzset{sankey fill/.append style={line width=0pt,gray!33}}

    \sankeyturn{e2}{-90}
    \sankeyadvance{e2}{.5}
    \sankeynodeend{1.98}{-90}{e2}{e2}

    \coordinate[below=0mm of e2.center] (e2 label);

    \tikzset{sankey fill/.append style={line width=0pt,gray!24}}

    \sankeyturn{e4}{-90}
    \sankeyadvance{e4}{2.54}
    \sankeynodeend{2.1}{-90}{e4}{e4}

    \coordinate[below=0mm of e4.center] (e4 label);

    \tikzset{sankey fill/.append style={line width=0pt,gray!26}}

    \sankeyturn{e5}{-90}
    \sankeyadvance{e5}{69pt}
    \sankeynodeend{0.36}{-90}{e5}{e5}

    \coordinate[right=3mm of e5.center] (e5 label);
    ...
    \node[label,right=0mm of e0 label] {Elektrische Energie\\ (Erneuerbare Energie)\\ (100\,\%)};
    \node[label,right=1mm of e1 label] {Chemische Energie\\ (Wasserstoff)\\ (65--69\,\%)};
    \node[label,left=1mm of e3 label] {Chemische Energie\\ (E-Fuels)\\(42-46\,\%)};
    \node[label,left=0mm of e6 label] {Bewegungsenergie\\(15--20\,\%)};

    \node[label,below=5mm of e2 label] {Energieentwertung\\Transfer,\\Umwandlung\\(31--35\,\%)};
    \node[label,below=4mm of e4 label] {Energieentwertung\\Synthese,\\Transport\\(19--27\,\%)};
    \node[label,below=5mm of e5 label] {Energieentwertung\\Verbrennungsmotor,\\Mechanik\\(22--31\,\%)};
\end{sankeydiagram}
    \end{tikzpicture}
\end{document}