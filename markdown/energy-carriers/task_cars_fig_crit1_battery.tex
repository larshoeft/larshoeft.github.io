...
%            sankey debug,
            ...
            \sankeynodestart{6}{0}{p0}{0,0};

            \coordinate[below=0mm of p0.center] (p0 label);

            \sankeyadvance{p0}{80pt}

            \tikzset{sankey fill/.append style={line width=0pt,gray!85,}}

            \sankeyfork{p0}{5.16/p1,.85/p2}

            \coordinate[below=0mm of p1.center] (p1 label);


            \sankeyadvance{p1}{75pt}

            \coordinate[below=0mm of p1.center] (p1b label);

            \sankeyadvance{p1}{75pt}

             \tikzset{sankey fill/.append style={line width=0pt,gray!66}}

            \sankeyfork{p1}{4.02/p3,1.14/p4}

            \sankeyadvance{p3}{75pt}

            \coordinate[above=0mm of p3.center] (p3 label);

            \sankeynodeend{4.02}{0}{p3}{p3}



            \tikzset{sankey fill/.append style={line width=0pt,gray!15}}


            \sankeyturn{p2}{-90}
            \sankeyadvance{p2}{.5}
            \sankeynodeend{.85}{-90}{p2}{p2}

            \coordinate[below=0mm of p2.center] (p2 label);

            \tikzset{sankey fill/.append style={line width=0pt,gray!19}}

            \sankeyturn{p4}{-90}
            \sankeyadvance{p4}{1.785}
            \sankeynodeend{1.14}{-90}{p4}{p4}

           \coordinate[below=0mm of p4.center] (p4 label);
            ...
            \node[label,right=1mm of p0 label] {Elektrische Energie\\ (Erneuerbare Energie)\\ (100\,\%)};
            \node[label,right=3mm of p1 label] {Chemische\\ Energie\\ (Akkumulator)\\ (84--88\,\%)};
            \node[label,right=3mm of p1b label] {Elektrische\\ Energie\\ (Akkumulator)\\ (84--88\,\%)};
            \node[label,left=1mm of p3 label] {Bewegungsenergie\\(64--70\,\%)};

            \node[label,below=5mm of p2 label] {Energieentwertung\\Transfer,\\ Umwandlung\\ (12--16\,\%)};
            \node[label,below=5mm of p4 label] {Energieentwertung\\Elektromotor,\\ Mechanik\\ (14--24\,\%)};
        \end{sankeydiagram}
