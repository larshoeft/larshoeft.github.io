...
\begin{document}
    ...
    \sankeynodestart{6}{0}{w0}{0,-195};

    \coordinate[right=0mm of w0.center] (w0 label);

    \sankeyadvance{w0}{80pt}

    \tikzset{sankey fill/.append style={line width=0pt,gray!67}}

    \sankeyfork{w0}{4.02/w1,1.98/w2}

    \coordinate[right=0mm of w1.center] (w1 label);

    \sankeyadvance{w1}{75pt}

    \tikzset{sankey fill/.append style={line width=0pt,gray!32}}

    \sankeyfork{w1}{1.92/w3,2.1/w4}

    \sankeyadvance{w3}{75pt}

    \coordinate[right=0mm of w3.center] (w3 label);

    \sankeyfork{w3}{1.56/w3,0.36/w5}

    \tikzset{sankey fill/.append style={line width=0pt,gray!23}}

    \sankeyadvance{w3}{75pt}

    \coordinate[right=0mm of w3.center] (w6 label);

    \sankeynodeend{1.56}{0}{w3}{w3}

    \tikzset{sankey fill/.append style={line width=0pt,gray!32}}

    \sankeyturn{w2}{-90}
    \sankeyadvance{w2}{.5}
    \sankeynodeend{1.98}{-90}{w2}{w2}

    \coordinate[right=0mm of w2.center] (w2 label);

    \tikzset{sankey fill/.append style={line width=0pt,gray!34}}

    \sankeyturn{w4}{-90}
    \sankeyadvance{w4}{2.54}
    \sankeynodeend{2.1}{-90}{w4}{w4}

    \coordinate[right=0mm of w4.center] (w4 label);

    \tikzset{sankey fill/.append style={line width=0pt,gray!7}}

        \sankeyturn{w5}{-90}
    \sankeyadvance{w5}{69pt}
    \sankeynodeend{0.36}{-90}{w5}{w5}

    \coordinate[right=3mm of w5.center] (w5 label);
    ...
    \node[label,right=0mm of w0 label] {Elektrische Energie\\ (Erneuerbare Energie)\\ (100\,\%)};
    \node[label,right=2mm of w1 label] {Chemische Energie\\ (Wasserstoff)\\ (65--69\,\%)};
    \node[label,left=1mm of w3 label] {Elektrische Energie\\ (Brennstoffzelle)\\(30--34\,\%)};
    \node[label,left=1mm of w6 label] {Bewegungsenergie\\(25--28\,\%)};

    \node[label,below=5mm of w2 label] {Energieentwertung\\Transfer,\\Umwandlung\\ (31--35\,\%)};
    \node[label,below=4mm of w4 label] {Energieentwertung\\Kompression,\\Transport\\Brennstoffzelle\\ (31--39\,\%)};
    \node[label,below=5mm of w5 label] {Energieentwertung\\Elektromotor,\\Mechanik\\ (2--9\,\%)};
\end{sankeydiagram}
